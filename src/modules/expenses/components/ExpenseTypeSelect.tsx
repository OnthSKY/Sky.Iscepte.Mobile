...
import AddExpenseTypeModal from '../../../shared/components/AddExpenseTypeModal';
...
export default function ExpenseTypeSelect({ value, options, placeholder = 'Seçiniz', onChange, onTypeAdded }: Props) {
  ...
  const handleAddSuccess = (type: ExpenseType) => {
